...
const TweetComposer = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    } else if (tenorGif) { // If no media files, check for tenorGif
              ...
              <form onSubmit={handleSubmit} className="flex flex-col">
                ...
                <div
                  className={`grid gap-2 mb-1 ${
                    mediaFiles.length === 1 || (mediaFiles.length === 2 && mediaFiles[0].type === "video") || tenorGif
                      ? "grid-cols-1"
                      : "grid-cols-2"
                  }`}
                >
                ...
                <div className="flex">
                  <div className="flex justify-between w-full my-3">
                    <div className="w-full flex">
                      ...
                      <label
                        htmlFor="file-input"
                        className={`w-fit p-2 ${mediaAveilable ? "hover:bg-primary-extraLight rounded-full cursor-pointer" : "opacity-50"}`}
                      >
                      ...
                      >
                        <label
                          className={`w-8 h-8 ${
                            (mediaFiles.length===0 && gifAvailable ?  "cursor-pointer" : (""))
                          }`}
                        >
                          <PollIcon
                            className={
                    ...
                    <div className="w-full h-full text-right">
                      <div className="flex h-full justify-end items-center">
                        ...
                        <button
                          disabled={tweet.length === 0 && mediaFiles.length===0}
                          type="submit"
